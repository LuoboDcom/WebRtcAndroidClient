...
public class JoinActivity extends AppCompatActivity {
    ...
    private static final int SET_REMOTE_OFFER = 0x03;
    private static final int CRATE_ANSWER = 0x04;
    private static final int RELEASE = 0x05;
                    ...
                    try {
                        ...
                        mPeerConnection.setRemoteDescription(
                                ...
                                new SessionDescription(
                                        ...
                                        description));
                        handler.sendEmptyMessage(CRATE_ANSWER);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    break;
                case CRATE_ANSWER:
                    Log.e(TAG, "4、CRATE_ANSWER");
                    MediaConstraints mediaConstraints = new MediaConstraints();
                    mPeerConnection.createAnswer(mSdpObserver, mediaConstraints);
                    break;
                case RELEASE:
                    finish();
                    break;
        ...
        mSdpObserver = new MySdpObserver() {
            ...
            public void onCreateSuccess(SessionDescription sessionDescription) {
                ...
                if (type == SessionDescription.Type.ANSWER) {
                    //应答
                    doAnswerCall(sessionDescription);
                }
            }
    ...
    public void doAnswerCall(SessionDescription sessionDescription) {
        JSONObject message = new JSONObject();
        try {
